...
{ case 1 : { printf ("\nEnter the total numbers you want to add");
   ...
   case 3 : { printf ("\nEnter the total numbers you want to multiply");
            ...
            {scanf("%lf",&arr[i]);
              ...
              break;
    case 4 : {printf("Enter the two numbers you want to divide");
             scanf("%lf%lf",&a1,&a2);
            printf("\nThe subtraction of two numbers is %2lf",a1/a2);}
            break;
    case 5 : {printf("Enter the number too calculate factorial ");
               scanf("%lf",&a1);
               printf("\nThe factorial of the number is %lf",fact(a1)); }
               break;
    case 6 : {printf("Enter the value of n and r ");
              scanf("%lf%lf",&a1,&a2);
              printf("\nThe nCr value is %lf",fact(a1)/(fact(a2)*fact(a1-a2)));}
              break;
    case 7 : {printf("Enter the value of n and r ");
              scanf("%lf%lf",&a1,&a2);
              printf("\nThe nCr value is %2lf",fact(a1)/fact(a1-a2));}
              break;
    case 8 : {printf("Enter the number and its power ");
            scanf("%lf%lf",&a1,&a2);
